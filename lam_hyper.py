...
def logo():
    ...
    {tim} ███████╗██║░░██║██║░╚═╝░██║  ░░░██║░░░██║███████╗╚█████╔╝
    {dac_biet} ╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚═╝  ░░░╚═╝░░░╚═╝╚══════╝░╚════╝░
    {xanh_la} </> Đăng kí kênh Youtube: Lâm Tilo DVFB để có nhiều tool vip nhé! </>
    \033[1;37m────────────────────────────────────────────────────────────
    {do}[{trang}{kt_code}{do}] {vang}TOOL BUFF VIEW TIKTOK 
    {do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m LÂM TILO
    {do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33m 0392913785
    {do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m LÂM TILO DVFB
    {do}[{trang}{kt_code}{do}] {xanh_la}FACEBOOK:\033[1;37m Phạm Trọng Lâm
    \033[1;37m────────────────────────────────────────────────────────────\n"""
